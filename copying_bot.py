...
async def on_message_code(bot, message):
	...
	if (message.server != None) and (message.channel != None):
...
args = []
if active_1:
	args.append(bot_1.start(token, bot=not(selfbot_1)))
	bot_1.loop.create_task(edit_check(bot_1))
if active_2:
	args.append(bot_2.start(token, bot=not(selfbot_2)))
	bot_2.loop.create_task(edit_check(bot_2))
if active_3:
	args.append(bot_3.start(token, bot=not(selfbot_3)))
	bot_3.loop.create_task(edit_check(bot_3))
if active_4:
	args.append(bot_4.start(token, bot=not(selfbot_4)))
	bot_4.loop.create_task(edit_check(bot_4))
if active_5:
	args.append(bot_5.start(token, bot=not(selfbot_5)))
	bot_5.loop.create_task(edit_check(bot_5))
if active_6:
	args.append(bot_6.start(token, bot=not(selfbot_6)))
